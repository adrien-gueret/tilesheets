...
export default (
  sheetSpring: Tilesheet,
  sheetSummer: Tilesheet,
  sheetFall: Tilesheet,
  sheetWinter: Tilesheet
) => {
  ...
  function switchSeason(season: Season) {
    const seasonToTilesheet: Record<Season, Tilesheet> = {
      spring: sheetSpring,
      summer: sheetSummer,
      fall: sheetFall,
      winter: sheetWinter,
  ...
  document.body.addEventListener("click", (e) => {
    ...
    switchSeason(target.dataset.season as Season);
